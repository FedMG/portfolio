import { SVGElement } from '../components/SVGs'

import type { FC } from 'react'
import type { BaseComponentProps } from '../schemas'

interface IconsProps extends Pick<BaseComponentProps, 'className'> {}
...
export const FolderIcon: FC<IconsProps> = ({ className }) => (
  <SVGElement
    viewBox='0 0 24 24'
    role='img'
    className={`w-6 h-6 stroke-current stroke-2 ${className}`}>
    <SVGElement.Path d='M2.25 12.75V12A2.25 2.25 0 014.5 9.75h15A2.25 2.25 0 0121.75 12v.75m-8.69-6.44l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z' />
    <SVGElement.Title title={"Portfolio's repository on GitHub"} />
  </SVGElement>
)
